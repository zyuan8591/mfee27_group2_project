<div class="new-product-page position_abs flex_center invisible">
    ...
    <form class="new-product-form position-rel" action="add-product-exe.php
    " method="GET">
        ...
        <div class="mb-3">
            ...
            <select name="company_id" class="form-select product-input">
                ...
                <?php else : ?>
                    ...
                    <option value="<?= $row["company_id"] ?>" selected><?= $companyName[$row["company_id"]] ?></option>
        ...
        <div class="mb-3 d-flex flex-column align-items-start">
            ...
            <label for="add-product-image" class="product-image">

                <img class="object-cover add-preview d-none product-img" src="" alt="">

                <svg class="svg" width="134" height="134" viewBox="0 0 134 134" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mb-3 flex_center">
            <button class="product-btn add-btn" type="submit transition">新增商品</button>
