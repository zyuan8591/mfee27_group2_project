<div class="new-recipe-page position_abs flex_center invisible">
    ...
    " method="GET">
        ...
        <div class="mb-3 d-flex flex-column align-items-start">
            ...
            <label for="add-recipe-image" class="add-recipe-image" >
                <div class="preview-add-img-container">
                    <img src="" alt="" class="object-cover d-none" id="recipeImgPre">
                    <svg id="recipeSvgPre" width="134" height="134" viewBox="0 0 134 134" fill="none" xmlns="http://www.w3.org/2000/svg">
