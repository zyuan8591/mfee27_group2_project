<div class="detail-page position_abs flex_center invisible">
    ...
    " method="GET">
        ...
        <div class="mb-3 row">
            <label for="" class="col-sm-auto col-form-label">商品主類別</label>
            <div class="col">
            <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="email@example.com">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="" class="col-sm-auto col-form-label">商品次類別</label>
            <div class="col">
            <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="email@example.com">
            </div>
        </div>
        ...
        <div class="mb-3 row d-flex align-items-center">
            ...
            <div class="col-sm-10 product-container row d-flex align-items-center">
                <div class="col-6">
                    <input type="text" class="form-control-plaintext " name="price" placeholder="請輸入商品價格">
                </div>
                <div class="col-4">
                    <input type="text" class="form-control-plaintext " name="inventory" placeholder="請輸入數量" >
                </div>
            </div>
        </div>            
