			...
			<tbody class="">
				<?php foreach ($rows as $row) : ?>
					...
					<tr class="">
						...
						<td class="">
							<a href="list-unlist.php?order=<?= $order ?>&filter=<?= $filterNum ?>&page=<?= $page ?>&id=<?= $row["id"] ?>&valid=<?= $row["valid"] ?>" class="table-btn <?php if ($row["valid"] == 1) {
																																															echo "point-none";
																																														} ?>">上架</a>
							<a href="list-unlist.php?order=<?= $order ?>&filter=<?= $filterNum ?>&page=<?= $page ?>&id=<?= $row["id"] ?>&valid=<?= $row["valid"] ?>" class="table-btn <?php if ($row["valid"] == 0) {
																																															echo "point-none";
																																														} ?>">下架</a>
