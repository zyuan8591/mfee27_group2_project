<div class="new-recipe-page position_abs flex_center invisible">
    ...
    " method="GET">
        ...
        <div class="mb-3">
            <label for="" class="form-label">食譜主分類</label>
            <input type="text" class="form-control" name="category_main" >
        </div>
        <div class="mb-3">
            <label for="" class="form-label">食譜次分類</label>
        ...
        <div class="mb-3 flex_center">
            <button class="btn save-and-add-recipe-btn " type="submit transition">新增食譜</button>
            <button class="btn back-recipe transition">返回食譜列表</button>
        </div>
    </form>
</div>